...
public class Asociacion {
    ...
    /*private List<Asociacion> results;

    public Asociacion(List<Asociacion> results) {
        this.results = results;
    }

    public List<Asociacion> getResults() {
        return results;
    }

    public void setResults(List<Asociacion> results) {
        this.results = results;
    }*/
